#############################################################################
# Makefile for building: Bin/Broxy
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  Broxy.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Broxy.pro CONFIG+=debug_and_release
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Broxy1.0.0
DISTDIR = /home/johnbanq/broxy-home/Broxy/.tmp/Broxy1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: Broxy.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile Broxy.pro CONFIG+=debug_and_release
