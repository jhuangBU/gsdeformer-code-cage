...
public:
	...
	void Load (const float * P, const float * N, int num_of_vertices,
	           ...
	           float se_size);
    void Load3DGS (const std::string& path_3dgs_folder, int base_res, float se_size, float threshold = 1e-6, bool allow_cache=true, bool use_tsdf=true);
