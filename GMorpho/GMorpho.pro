...
add_cuda_source (SimplifiedVoxelizer.cu)
add_cuda_source (GSVoxelizer.cu)
...
HEADERS += BVH.h 
HEADERS += Voxelizer.h
HEADERS += SimplifiedVoxelizer.h
HEADERS += GSVoxelizer.h
HEADERS += FrameField.h 
HEADERS += ScaleField.h 
HEADERS += GMorpho.h 
HEADERS += MarchingCubesMesher.h
HEADERS += npy.h
HEADERS += PythonScriptWrapper.h

SOURCES = PythonScriptWrapper.cpp