...
public:
    ...
    // Update only vertex positions (topology unchanged). Returns false if size mismatch.
    bool UpdateVertexPositions(const MorphoGraphics::Mesh &mesh);
    ...
    inline void set_use_linear_constraints(float use_linear_constraints) {
