...
static __inline__ __device__ void atomicAdd(c10::Half* address, c10::Half val) {
    ...
    do {
        ...
        half tmpres = __hadd(*reinterpret_cast<const half*>(&hsum), *reinterpret_cast<const half*>(&val));
        hsum = __half_raw{*reinterpret_cast<const unsigned short*>(&tmpres)};
...
int chamfer_cuda_forward(at::Tensor& xyz1, at::Tensor& xyz2, at::Tensor& dist1, at::Tensor& dist2, at::Tensor& idx1, at::Tensor& idx2){
	...
	TORCH_CHECK(xyz2.size(2) == c, "xyz2 dimension mismatch");
