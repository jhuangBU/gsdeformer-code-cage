...
class Decimator {
	public:
        ...
        inline int num_vertices () { return num_vertices_; }
        ...
        inline void set_num_vertices (int num_vertices) { num_vertices_ = num_vertices; }
		...
		static void LoadPLY (const std::string & filename, MorphoGraphics::Mesh & output_mesh);
